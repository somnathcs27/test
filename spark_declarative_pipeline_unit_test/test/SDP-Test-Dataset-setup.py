...
#dbutils.fs.rm("/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/customers/users_json", True)
#dbutils.fs.mkdirs("/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/users_json")
#dbutils.fs.mkdirs("/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/spend_csv")

#import shutil
#shutil.copyfile("./dataset/users.json", "/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/users_json/users.json")
#shutil.copyfile("./dataset/spend.csv", "/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/spend_csv/spend.csv")
...
# dbutils.fs.put('/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/spend_csv/spend.csv', spend_csv, True)
dbutils.fs.put(f'{volume_folder}/test/spend_csv/spend.csv', spend_csv, True)
...
# dbutils.fs.put('/Volumes/main/dbdemos_sdp_unit_test/raw_data/test/users_json/users.json', users_json, True)
dbutils.fs.put(f'{volume_folder}/test/users_json/users.json', users_json, True)
...
# MAGIC %fs head /Volumes/main/dbdemos_sdp_unit_test/raw_data/test/users_json/users.json
...
# MAGIC %fs head /Volumes/main/dbdemos_sdp_unit_test/raw_data/test/spend_csv/spend.csv
