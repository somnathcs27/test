...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=7474657585814701&notebook=%2Ftest%2FSDP-Tests&demo_name=declarative-pipeline-unit-test&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdeclarative-pipeline-unit-test%2Ftest%2FSDP-Tests&version=1">
...
-- MAGIC %md
-- MAGIC Open the [/sdp-python/transformations/test/01-bronze-test.py]($../sdp-python/transformations/test/01-bronze-test.py) to check out on how to make sure incorrect input rows (bad schema) are dropped
...
-- MAGIC %md
-- MAGIC Open the [/sdp-python/transformations/test/02-silver-test.py]($../sdp-python/transformations/test/02-silver-test.py) to check out on how to test the silver layer
...
-- MAGIC %md
-- MAGIC Open the [/sdp-python/transformations/test/03-gold-test.py]($../sdp-python/transformations/test/03-gold-test.py) to check out on how to test the gold layer
...
-- MAGIC
-- MAGIC You can open the <a dbdemos-pipeline-id="sdp-test" href="#joblist/pipelines/8c2bc724-0597-4aa5-afe0-6270e4375249">Spark Declarative Pipelines Pipeline for unit-test</a> to see the tests in action